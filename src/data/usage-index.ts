...
export const usageIndex = {
  entries: [
    ...
    },
    {
      ...
      refs: ['B-13', 'B-16L', 'B-55', 'L-1', 'L-2', 'L-10'],
    },
    {
      title: 'Stratifié',
    ...
    },
    {
      ...
      refs: ['B-21', 'B-22', 'B-23', 'B-24', 'B-25', 'B-26', 'B-27', 'B-52', 'P-47210', 'P-47232', 'No.51'],
    },
    {
  ...
  noteHtml:
    '\n    Les anciennes lames Makita à queue universelle (série numérotée à code A-858xx) ne sont pas compatibles avec la fixation\n    par baionnette et ne figurent pas dans cet index. Seules les lames à emmanchement baionnette (également connue sous le nom de tige en T) sont retenues.\n  ',
  footLine: `Guide des lames de scie sauteuse Makita emmanchement baionnette (tige en T) · Édition du ${packageJson.editionDate}`,
};
