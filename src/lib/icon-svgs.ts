...
export const ICON_SVGS: Record<IconKey, string> = {
  'fast-cut': `<path d="M13 2.5L5.5 13H10l-1.2 8.5L18.5 10H13z" fill="currentColor"/>`,
  ...
  'blade-length': `<rect x="3" y="9" width="18" height="6" rx="1" fill="none" stroke="currentColor" stroke-width="1.6"/>
        <path d="M7 9v2.4M11 9v3M15 9v2.4M19 9v3" stroke="currentColor" stroke-width="1.2"/>`,
  'cut-thickness': `<path d="M6 4v16M18 4v16" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
  ...
  'tooth-type': `<path d="M3 17h12M5 17l1.6-4 1.6 4 1.6-4 1.6 4 1.6-4 1.6 4" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/>
  ...
  softwood: `<rect x="3" y="7" width="18" height="10" rx="1.2" fill="none" stroke="currentColor" stroke-width="1.6"/>
  ...
  hardwood: `<rect x="3" y="6" width="18" height="12" rx="1.2" fill="none" stroke="currentColor" stroke-width="1.6"/>
  ...
  plywood: `<rect x="3" y="7" width="18" height="10" rx="1.2" fill="none" stroke="currentColor" stroke-width="1.6"/>
        <path d="M3.4 10.5h17.2M3.4 13.5h17.2" stroke="currentColor" stroke-width="1.1"/>`,
  'mdf-particleboard': `<rect x="3" y="7" width="18" height="10" rx="1.2" fill="none" stroke="currentColor" stroke-width="1.6"/>
  ...
  'laminate-flooring': `<rect x="3" y="6" width="18" height="12" rx="1.2" fill="none" stroke="currentColor" stroke-width="1.6"/>
  ...
  plastic: `<rect x="5" y="5" width="14" height="14" rx="2.5" fill="none" stroke="currentColor" stroke-width="1.6"/>
  ...
  aluminum: `<path d="M6 4v15h14v-3.6h-10.4V4z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>`,
  steel: `<path d="M3 14.5l5.5-6h12.5l-5.5 6z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>
        <path d="M3 14.5v2.4l12.5 0v-2.4" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/>`,
  'stainless-steel': `<path d="M3 15l5-5.5h11l-5 5.5z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
        <path d="M17.5 5.5l.8 2.1 2.1.8-2.1.8-.8 2.1-.8-2.1-2.1-.8 2.1-.8z" fill="currentColor"/>`,
  'non-ferrous-metal': `<rect x="3" y="9.5" width="18" height="5" rx="0.6" fill="none" stroke="currentColor" stroke-width="1.6"/>
        <path d="M7 9.5l-2 5M11 9.5l-2 5M15 9.5l-2 5M19 9.5l-2 5" stroke="currentColor" stroke-width="1"/>`,
  'tile-fiberglass-cement': `<rect x="4" y="4" width="16" height="16" rx="1.2" fill="none" stroke="currentColor" stroke-width="1.6"/>
        <path d="M4 12h16M12 4v16" stroke="currentColor" stroke-width="1.2"/>`,
  'leather-rubber-foam': `<path d="M4 8c3-2 5 2 8 0s5-2 8 0v8c-3 2-5-2-8 0s-5 2-8 0z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>`,
};
